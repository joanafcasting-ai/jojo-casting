                      ...
                      {/* Profile card with integrated selection */}
                        <div style={{ position: "relative" }}>
                          <ProfileCard
                            ...
                            viewMode={viewMode}
                          />
                          {/* Selection buttons — OUI / PEUT-ÊTRE / NON */}
                          <div style={{ marginTop: 6, display: "flex", gap: 6 }}>
                            {[
                              { choice: "yes", label: "OUI ✓", color: "#22c55e", bg: "rgba(34,197,94,0.08)" },
                              { choice: "maybe", label: "PEUT-ÊTRE ~", color: "#f59e0b", bg: "rgba(245,158,11,0.08)" },
                              { choice: "no", label: "NON ✕", color: "#ef4444", bg: "rgba(239,68,68,0.08)" },
                            ].map(opt => {
                              const isActive = state.selections[profile.id]?.choice === opt.choice;
                              return (
                                <button key={opt.choice}
                                  ...
                                  style={{
                                    ...
                                    border: isActive ? `2px solid ${opt.color}` : "1px solid #222",
                          ...
                          {/* Show selection status + contact */}
                          {state.selections[profile.id]?.choice && (
