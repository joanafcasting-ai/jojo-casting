  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const data = await window.storage.get(`shared:${shareCodeFromUrl}`, true);
        ...
        console.error("[Guest] Error loading project:", e);
        ...
        <>
          ...
          <div style={{ minHeight: "100vh", background: "#0a0a0c", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
            <div style={{ textAlign: "center", animation: "fadeIn 0.5s" }}>
              ...
              <p style={{ fontSize: 13, color: "#666", marginBottom: 8 }}>{guestError || "Ce lien de partage n'est plus valide ou le projet a été supprimé."}</p>
              <p style={{ fontSize: 11, color: "#444" }}>Code: {shareCodeFromUrl}</p>
            </div>
          </div>
        </>
      );
