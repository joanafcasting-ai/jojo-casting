...
// Storage compatibility layer: replaces Claude's window.storage with localStorage
if (!window.storage || !window.storage._real) {
  window.storage = {
    _real: true,
              ...
              {authState === "login" ? (
                <>
                  ...
                  <button onClick={() => handleLogin("google")}
                    style={{
                      width: "100%", padding: "14px 20px", borderRadius: 12, border: "1px solid #2a2a2e",
                      background: "#fff", color: "#333", fontSize: 14, fontWeight: 600, fontFamily: "inherit",
                  ...
                  <button onClick={() => handleLogin("apple")}
                    style={{
                      width: "100%", padding: "14px 20px", borderRadius: 12, border: "1px solid #2a2a2e",
                      background: "#000", color: "#fff", fontSize: 14, fontWeight: 600, fontFamily: "inherit",
                      cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10,
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 20 }}>
                    ...
                    <span style={{ fontSize: 11, color: "#555", fontWeight: 500 }}>ou par email</span>
                    <div style={{ flex: 1, height: 1, background: "#2a2a2e" }} />
                  </div>
