          ...
          <header style={{
            ...
            <div style={{ position: "relative" }}>
              <input value={globalSearch} onChange={e => { setGlobalSearch(e.target.value); setGlobalSearchOpen(true); }}
                onFocus={() => { if (globalSearch.length >= 2) setGlobalSearchOpen(true); }}
                ...
                onFocus={e => e.target.style.borderColor="#c9a44a"} onBlur={e => { setTimeout(() => setGlobalSearchOpen(false), 200); e.target.style.borderColor="#2a2a2e"; }} />
